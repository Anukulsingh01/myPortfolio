...
// --- DATA ---
const TITLES = ["SOFTWARE DEVELOPER", "WEB DEVELOPER", "MERN STACK"];

const TIMELINE = [
  {
    type: "EDUCATION",
    title: "High School (10th)",
    org: "G.H.S.S Aambagh, Tanakpur, Uttarakhand",
    date: "2018 — 2019",
    desc: "Science Stream."
  },
  {
    ...
    org: "T.S.S.R.J.S.R.RHGIC, Tanakpur, Uttarakhand",
    date: "2020 — 2021",
    desc: "PCM"
  },
  {
    ...
    org: "VEER MADHO SINGH BHANDARI UTTARAKHAND TECHNICAL UNIVERSITY",
    date: "2021 — 2025",
...
const CERTIFICATES = [
  { name: "FULL STACK DEVELOPER CERTIFICATION", issuer: "GFG", date: "2025", url: "/gfgCertificate.pdf" },
];

const PROJECTS = [
  {
    title: "GymWhallah",
    description: "GymWhallah is a web application that helps users explore gym exercises, workout routines, and fitness information in an easy and organized way. It provides a simple interface to discover exercises and improve workout planning.",
    tech: ["MONGODB", "EXPRESS", "REACT", "NODE", "TAILWIND CSS"],
    github: "https://github.com/Anukulsingh01/gymwalApp", 
    link: "#",
  },
  {
    title: "HelloHii",
    description: "HelloHi is a real-time chat web application that allows users to communicate instantly using WebSocket technology with a responsive and modern interface.",
    tech: ["MONGODB", "EXPRESS", "REACT", "NODE","WEBSOCKET","TAILWIND CSS"],
    github: "https://github.com/Anukulsingh01/ChatApp", 
    link: "#",
  },
  {
    title: "oneCart",
    description: "Developed OneCart, an e-commerce web application that enables users to browse products, add items to a shopping cart, and manage purchases. Implemented responsive UI and core shopping functionalities to enhance the user experience.",
    tech: ["MONGODB", "EXPRESS", "REACT", "NODE", "TAILWIND CSS"],
    github: "https://github.com/Anukulsingh01/onecart", 
    link: "#",
  },
...
const Navbar = ({ isDark, setIsDark }) => (
  <nav className={`fixed top-0 w-full z-50 backdrop-blur-md py-5 px-6 md:px-12 flex justify-between items-center border-b transition-all duration-300 ${isDark ? 'bg-[#0a192f]/90 border-white/5' : 'bg-white/90 border-black/5'}`}>
    <div className={`font-bold text-2xl font-mono tracking-widest uppercase ${isDark ? 'text-[#64ffda]' : 'text-[#0a192f]'}`}>A-CooL</div>
    <div className="hidden md:flex gap-10 items-center font-mono text-sm uppercase tracking-[0.2em]">
      ...
      <a href="public/myCV.pdf" download className={`border-2 px-6 py-2 rounded-sm transition tracking-widest font-bold ${isDark ? 'border-[#64ffda] text-[#64ffda] hover:bg-[#64ffda] hover:text-[#0a192f]' : 'border-[#0a192f] text-[#0a192f] hover:bg-[#0a192f] hover:text-white'}`}>RESUME</a>
    </div>
  </nav>
);
    ...
    <div className={`${themeClasses.bg} ${themeClasses.text} min-h-screen font-sans selection:bg-[#64ffda]/30 selection:text-[#64ffda] scroll-smooth transition-colors duration-500`}>
      ...
      <footer id="contact" className={`py-32 text-center border-t transition-all ${isDark ? 'bg-[#0a192f]/30 border-white/5' : 'bg-slate-50 border-black/5'}`}>
        ...
        <div className="flex justify-center gap-10 mb-20">
           <a href="https://www.linkedin.com/in/anukul-singh-bisht-b16706296/" target="_blank" rel="noreferrer" className={`w-16 h-16 border flex items-center justify-center transition-all ${isDark ? 'border-[#64ffda]/40 text-[#64ffda] hover:bg-[#64ffda] hover:text-[#0b0e14]' : 'border-[#0a192f]/40 text-[#0a192f] hover:bg-[#0a192f] hover:text-white'}`}>
             <Linkedin size={28} />
           </a>
           <a href="https://github.com/Anukulsingh01" target="_blank" rel="noreferrer" className={`w-16 h-16 border flex items-center justify-center transition-all ${isDark ? 'border-[#64ffda]/40 text-[#64ffda] hover:bg-[#64ffda] hover:text-[#0b0e14]' : 'border-[#0a192f]/40 text-[#0a192f] hover:bg-[#0a192f] hover:text-white'}`}>
             <Github size={28} />
           </a>
           <a href="mailto:anukulsinghbisht@gmail.com" className={`w-16 h-16 border flex items-center justify-center transition-all ${isDark ? 'border-[#64ffda]/40 text-[#64ffda] hover:bg-[#64ffda] hover:text-[#0b0e14]' : 'border-[#0a192f]/40 text-[#0a192f] hover:bg-[#0a192f] hover:text-white'}`}>
             <Mail size={28} />
           </a>
        </div>
        <div className="space-y-4 font-mono uppercase">
          <p className="text-[9px] text-slate-500 tracking-[0.8em]">BUILT_WITH_PRECISION</p>
          <p className={`${isDark ? 'text-[#64ffda]' : 'text-[#0a192f]'} text-xs font-bold tracking-[0.4em]`}>Anukul Singh Bisht </p>
        </div>
      </footer>
    </div>
  );
